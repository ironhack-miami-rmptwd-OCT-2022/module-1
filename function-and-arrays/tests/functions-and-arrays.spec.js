...
describe('Bonus Quest - greatestProduct', () => {
  ...
  it('should return 24 when all the numbers of the arrays are 2 except there is a 3', () => {
    let matrix = [
  ...
  it('should return 24 when all the numbers of the arrays are 2 except one 3', () => {
    let matrix = [
      [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
      [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
      [2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2, 2],
    ...
    expect(greatestProduct(matrix)).toBe(36);
  });
});
